...
to setup
  ...
  ;; lists used to generate positions of houses
  set max-xcor-list n-values (max-xcor / 2) [i -> 2 * i]
  set max-ycor-list n-values (max-ycor / 2) [i -> 2 * i]
...
to infect
  ask n-of num-infected persons [
    ...
    ;; random number picked from 0 to 99
    set am-i-going-to-die random-float 100

    ;; random number picked from 0 to 4
...
to calculate-r-zero
  ...
  ;; end of day
  tick-counter = 1440 [
    ;;show infected-persons
    ;;show currently-infected
...
to move
    ;;n-of random ( count persons with [depart-wave = 0]) persons with [depart-wave = 0] [
...
"" ""
PENS
"asymptotic" 6.94E-4 0 -4079321 true "" "plot count persons with [total-days-with-covid < incubation-period and infected? = true]"
"symptotic" 6.94E-4 0 -2674135 true "" "plot count persons with [will-i-stay-at-home > percentage-staying-home and total-days-with-covid > incubation-period and infected? = true] "
