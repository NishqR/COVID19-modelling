...
to spread-infection
  ...
  ask persons with [ infected? ] [
    ...
    if ( count persons-here > 1 ) and ( total-days-with-covid >= infectious-period ) and (total-days-with-covid < (incubation-period - infectious-days) + 10)[;; and (random 250 = 0) [
      ...
      ask persons-here [
        if infected? = false and immune? = false[;; and mask-on? = false[
          ;;show "yo"
...
<experiments>
  ...
  <experiment name="experiment" repetitions="30" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="policy-intervention?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="percentage-daily-travel">
      <value value="25"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
